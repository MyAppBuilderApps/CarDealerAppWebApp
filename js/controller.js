...
var fssi;
var floatid = '';
var shareurl = "http://build.myappbuilder.com/";
var shareurlid;
...
//                                  alert(data.title);
                                  ...
                                  .success(function(reskey){
                                           ...
                                           .error(function(data, status) {
                                                  $ionicPopup.alert({title: 'Car Dealers',content:data.error});
                                                  $ionicLoading.hide();
                                                  });
                                           }
                                           }
                                           
                                           $http.get('http://build.myappbuilder.com/api/time.json', {}, {
                                                     transformRequest: angular.identity,
                                                     headers: {'Content-Type': undefined}
                                                     }).
                                           success(function(data) {
                                                   
                                                   var d = Number(data[1]+data[2]+data[3]+data[4]);
                                                   var n = d+1;
                                                   
                                                   for(var j=n;j>=1900;j--){
                                                   yeararr.push(j);
                                                   }
                ...
                .error(function(data, status) {
                   ...
                   $.ajax({
                          ...
                          $ionicPopup.alert({title: 'Car Dealers',content:error.error});;
                          }
                          });
                   ...
                   .success(function(data){
                            ...
                            .success(function(data, status){
                                     ...
                                     .success(function(reskey){
                                              ...
                                              .error(function(data, status) {
                                                     $ionicPopup.alert({title: 'Login',content:data.error});
                                                     $ionicLoading.hide();
                                                     });
                                              }
                                              }
...
//                            appKey = response.api_key;
                            ...
                            .success(function(data, status){
                                     ...
                                     $ionicLoading.hide();
                                      $ionicPopup.alert({title: 'Login',content:"You are not authorised for this app!"});
                                     }
                                     })
                            .error(function(data, status) {
                                   $ionicPopup.alert({title: 'Login',content:data.error});
                   ...
                   .error(function(error, status) {
                          $ionicLoading.hide();
                          var error = JSON.parse(error.responseText);
                          $ionicPopup.alert({title: 'Login',content:error.error})
                          });
...
control.controller('menuCtrl', function($scope, $state, $ionicModal,$ionicScrollDelegate,$ionicLoading,$ionicPopup,$http,$ionicActionSheet){
                   ...
                   .error(function(data, status) {
                          ...
                          $ionicLoading.hide();
                            ...
                            .error(function(data, status) {
                                   $ionicPopup.alert({title: 'Car Dealers',content:'Invalid Key'});
                                   $ionicLoading.hide();
                                   });
...
control.controller('addBookCtrl',function($scope, $state,$ionicPopup,$ionicLoading,$ionicScrollDelegate,$http, $ionicActionSheet){
                   ...
                   $scope.appcreate = {};
                   $scope.book = {};
                   $scope.appcreate.url = "http://build.myappbuilder.com/";
                  ...
                  $("#bookImage").change(function(){
                   ...
                   $.ajax({
                          ...
                          booktype.append('value','Car Dealers');
                          ...
                          var formData = new FormData();
                                     ...
                                     $.ajax({
                                       ...
                                       var myPopup = $ionicPopup.alert({
                                                                       ...
                                                                       title: appTitle,
                                                                       subTitle: 'Successfully created Car Dealers Title! ',
                                                                       scope: $scope,
...
//                                       image = undefined;
                   ...
                   $ionicPopup.alert({title: 'Car Dealers',content:"Enter Social Share URL"});
                   }
                   }else{
                   $ionicPopup.alert({title: 'Car Dealers',content:"Select Car Dealers Image & Enter Car Dealers Title"});
                   }
                   }
...
control.controller('addChapterCtrl',function($state,$scope,$ionicPopup,$ionicNavBarDelegate,$ionicLoading,$ionicScrollDelegate,$ionicActionSheet){
                  ...
                  function readURL1(input) {
                   ...
                   $ionicLoading.hide();
                   $ionicPopup.alert({title: 'Listings',content:"Enter New Listing Title and Image"});
                   }
                   }
                   });
...
control.controller('addContentCtrl',function($scope,$state,$ionicPopup,$sce,$ionicLoading,$ionicScrollDelegate,$http,$ionicModal,$ionicActionSheet){
                            ...
                            .success(function(data, status){
                                     ...
                                     .success(function(reskey){
                                              ...
                                              myPopup = $ionicPopup.show({
                                                                         template: '<div class="list"><div class="item item-icon-right" ng-click="editContent();">'+$scope.appChapter+'<i class="icon ion-compose"></i></div><div class="item item-icon-right" ng-click="createContent();">Create New Content<i class="icon ion-ios7-plus"></i></div><div class="item item-icon-right" ng-click="createChapter();">Create New Listing<i class="icon ion-ios7-plus"></i></div><div class="item item-icon-left" ng-click="goToHome();"><i class="icon ion-home"></i>Car Dealers Home</div></div>',
                                                                         title: $scope.appChapter,
                                                                         subTitle: 'Successfully added Car Dealers Listing Content!',
                                                                         scope: $scope,
                ...
                $scope.createContent = function(){
                   ...
                   $scope.contentCreate.elementAdditional_field = 'Sale';
                   $scope.contentCreate.elementTag = '';
                   $scope.contentCreate.elementSquarefeet = '';
                   $scope.contentCreate.elementAddress = '';
                   $scope.contentCreate.elementModel = '';
                   $scope.contentCreate.elementType = '';
                   $scope.contentCreate.elementColor = '';
                   $scope.contentCreate.elementVariant1 = '';
                   $scope.contentCreate.elementYear = '';
                   $scope.contentCreate.elementVariant = '';
                   $scope.selectedsale=true;
                   $scope.selectedrent=false;
                   elementId ='';
                   contentTitle = '';
                  ...
                  $("#tst").change(function(){
                   ...
                   alert('Please Enter Your Content Title!',alertDismissed,'Car Dealers','done');
                   }
                   ...
                   $.ajax({
                          ...
                          $.ajax({
                                 ...
                                 $.ajax({
                                        ...
                                        $state.reload();
                                        $ionicLoading.hide();
                                        $ionicPopup.alert({title: 'Car Dealers',content:'Selected contact(s) has been added succesfully!'});
...
//                   alert($scope.addagent.fname);
                   ...
                   $ionicLoading.hide();
                   $ionicPopup.alert({title: 'Car Dealers',content:'Please Enter a Valid Email'});
                   }
                   }
                   
                   else{
                   $ionicLoading.hide();
                   $ionicPopup.alert({title: 'Car Dealers',content:'Please Enter a Valid Name'});
                   }
                 ...
                 if($scope.contentCreate.elementTag=='' || $scope.contentCreate.elementTag==undefined){
                   ...
                   $.ajax({
                          ...
                          formData7.append('api_key',appKey);
                          formData7.append('element_id',elementId);
                          formData7.append('title','Model');
                          formData7.append('value',$scope.contentCreate.elementModel);
                          formData8.append('api_key',appKey);
                          formData8.append('element_id',elementId);
                          formData8.append('title','Type');
                          formData8.append('value',$scope.contentCreate.elementType);
                          formData9.append('api_key',appKey);
                          formData9.append('element_id',elementId);
                          formData9.append('title','Color');
                          formData9.append('value',$scope.contentCreate.elementColor);
                          formData10.append('api_key',appKey);
                          formData10.append('element_id',elementId);
                          formData10.append('title','Variant');
                          if($scope.contentCreate.elementVariant=='Other'){
                          formData10.append('value',$scope.contentCreate.elementVariant1);
                          }
                          else{
                          formData10.append('value',$scope.contentCreate.elementVariant);
                          }
                          
                          formData11.append('api_key',appKey);
                          formData11.append('element_id',elementId);
                          formData11.append('title','Year');
                          formData11.append('value',$scope.contentCreate.elementYear);
                          ...
                          $.ajax({
                                 ...
                                 error:function(error,status){
                                 $ionicLoading.hide();
                                 alert("error12331: "+error.responseText);
                                 }
                                 });
                          $.ajax({
                                 type: methodData,
                          ...
                          formData6.append('value',$scope.contentCreate.elementPrice);
                          formData7.append('api_key',appKey);
                          formData7.append('id',Modelid);
                          formData7.append('title','Model');
                          formData7.append('value',$scope.contentCreate.elementModel);
                          formData8.append('api_key',appKey);
                          formData8.append('id',Typeid);
                          formData8.append('title','Type');
                          formData8.append('value',$scope.contentCreate.elementType);
                          formData9.append('api_key',appKey);
                          formData9.append('id',Colorid);
                          formData9.append('title','Color');
                          formData9.append('value',$scope.contentCreate.elementColor);
                          formData10.append('api_key',appKey);
                          formData10.append('id',Variantid);
                          formData10.append('title','Variant');
                          if($scope.contentCreate.elementVariant=='Other'){
                          formData10.append('value',$scope.contentCreate.elementVariant1);
                          }
...
control.controller('previewChapterCtrl', function($scope,$state,$ionicModal,$ionicLoading,$ionicScrollDelegate,$ionicPopup,$http,$ionicSideMenuDelegate,$ionicActionSheet){
                   ...
                   .success(function(data){
                            ...
                            .success(function(data, status){
                                     ...
                                     .success(function(reskey){
                                              ...
                                              .error(function(data, status) {
                                                     var error = JSON.parse(error.responseText);
                          $ionicPopup.alert({title: 'Listings',content:data.error})
                                                     $ionicLoading.hide();
                                                     });
                                              }
                                              }
                   ...
                   $scope.deleteApp = function(appId,item){
                   if(appId==defaultkey){
                   $ionicPopup.alert({title: 'Listings',content:'You cannot delete this root App!'});
                   }
                   else{
                   var confirmPopup = $ionicPopup.confirm({
                                                          title: item,
...
control.controller('agentsCtrl', function($scope,$state,$ionicModal,$ionicLoading,$ionicScrollDelegate,$ionicPopup,$http,$ionicSideMenuDelegate,$ionicActionSheet){
                   ...
                   $.ajax({
                          ...
                          $ionicLoading.hide();
                          var error = JSON.parse(error.responseText);
                          $ionicPopup.alert({title: 'Agents',content:error.error})
                          }
                          });
                   });
...
control.controller('previewSubTitleCtrl',function($scope,$state,$ionicModal,$ionicLoading,$ionicScrollDelegate,$ionicPopup,$http,$ionicActionSheet){
                   ...
                   else if(elementArray[i].custom_values[0].title == "Model"){
                   Model = elementArray[i].custom_values[0].value;
                   Modelid = elementArray[i].custom_values[0].id;
                   }
                   else if(elementArray[i].custom_values[0].title == "Type"){
                   Type = elementArray[i].custom_values[0].value;
                   Typeid = elementArray[i].custom_values[0].id;
                   }
                   else if(elementArray[i].custom_values[0].title == "Color"){
                   Color = elementArray[i].custom_values[0].value;
                   Colorid = elementArray[i].custom_values[0].id;
                   }
                   else if(elementArray[i].custom_values[0].title == "Variant"){
                   Variant = elementArray[i].custom_values[0].value;
                   Variantid = elementArray[i].custom_values[0].id;
                   }
                   else if(elementArray[i].custom_values[0].title == "Year"){
                   Year = elementArray[i].custom_values[0].value;
                   Yearid = elementArray[i].custom_values[0].id;
                   }
                   ...
                   else if(elementArray[i].custom_values[1].title == "Model"){
                   Model = elementArray[i].custom_values[1].value;
                   Modelid = elementArray[i].custom_values[1].id;
                   }
                   else if(elementArray[i].custom_values[1].title == "Type"){
                   Type = elementArray[i].custom_values[1].value;
                   Typeid = elementArray[i].custom_values[1].id;
                   }
                   else if(elementArray[i].custom_values[1].title == "Color"){
                   Color = elementArray[i].custom_values[1].value;
                   Colorid = elementArray[i].custom_values[1].id;
                   }
                   else if(elementArray[i].custom_values[1].title == "Variant"){
                   Variant = elementArray[i].custom_values[1].value;
                   Variantid = elementArray[i].custom_values[1].id;
                   }
                   else if(elementArray[i].custom_values[1].title == "Year"){
                   Year = elementArray[i].custom_values[1].value;
                   Yearid = elementArray[i].custom_values[1].id;
                   }
                   ...
                   else if(elementArray[i].custom_values[2].title == "Model"){
                   Model = elementArray[i].custom_values[2].value;
                   Modelid = elementArray[i].custom_values[2].id;
                   }
                   else if(elementArray[i].custom_values[2].title == "Type"){
                   Type = elementArray[i].custom_values[2].value;
                   Typeid = elementArray[i].custom_values[2].id;
                   }
                   else if(elementArray[i].custom_values[2].title == "Color"){
                   Color = elementArray[i].custom_values[2].value;
                   Colorid = elementArray[i].custom_values[2].id;
                   }
                   else if(elementArray[i].custom_values[2].title == "Variant"){
                   Variant = elementArray[i].custom_values[2].value;
                   Variantid = elementArray[i].custom_values[2].id;
                   }
                   else if(elementArray[i].custom_values[2].title == "Year"){
                   Year = elementArray[i].custom_values[2].value;
                   Yearid = elementArray[i].custom_values[2].id;
                   }
                   ...
                   else if(elementArray[i].custom_values[3].title == "Model"){
                   Model = elementArray[i].custom_values[3].value;
                   Modelid = elementArray[i].custom_values[3].id;
                   }
                   else if(elementArray[i].custom_values[3].title == "Type"){
                   Type = elementArray[i].custom_values[3].value;
                   Typeid = elementArray[i].custom_values[3].id;
                   }
                   else if(elementArray[i].custom_values[3].title == "Color"){
                   Color = elementArray[i].custom_values[3].value;
                   Colorid = elementArray[i].custom_values[3].id;
                   }
                   else if(elementArray[i].custom_values[3].title == "Variant"){
                   Variant = elementArray[i].custom_values[3].value;
                   Variantid = elementArray[i].custom_values[3].id;
                   }
                   else if(elementArray[i].custom_values[3].title == "Year"){
                   Year = elementArray[i].custom_values[3].value;
                   Yearid = elementArray[i].custom_values[3].id;
                   }
                   
                   if(elementArray[i].custom_values[4].title == "House Condition"){
                   House_Condition = elementArray[i].custom_values[4].value;
                   House_Conditionid = elementArray[i].custom_values[4].id;
                   }
                   else if(elementArray[i].custom_values[4].title == "Square Feet"){
                   Square_Feet = elementArray[i].custom_values[4].value;
                   Square_Feetid = elementArray[i].custom_values[4].id;
                   }
                   else if(elementArray[i].custom_values[4].title == "Address"){
                   Address = elementArray[i].custom_values[4].value;
                   Addressid = elementArray[i].custom_values[4].id;
                   }
                   else if(elementArray[i].custom_values[4].title == "Price"){
                   contentPrice = elementArray[i].custom_values[4].value;
                   contentPriceid = elementArray[i].custom_values[4].id;
                   }
                   else if(elementArray[i].custom_values[4].title == "Model"){
                   Model = elementArray[i].custom_values[4].value;
                   Modelid = elementArray[i].custom_values[4].id;
                   }
                   else if(elementArray[i].custom_values[4].title == "Type"){
                   Type = elementArray[i].custom_values[4].value;
                   Typeid = elementArray[i].custom_values[4].id;
                   }
                   else if(elementArray[i].custom_values[4].title == "Color"){
                   Color = elementArray[i].custom_values[4].value;
                   Colorid = elementArray[i].custom_values[4].id;
                   }
                   else if(elementArray[i].custom_values[4].title == "Variant"){
                   Variant = elementArray[i].custom_values[4].value;
                   Variantid = elementArray[i].custom_values[4].id;
                   }
                   else if(elementArray[i].custom_values[4].title == "Year"){
                   Year = elementArray[i].custom_values[4].value;
                   Yearid = elementArray[i].custom_values[4].id;
                   }
                   
                   if(elementArray[i].custom_values[5].title == "House Condition"){
                   House_Condition = elementArray[i].custom_values[5].value;
                   House_Conditionid = elementArray[i].custom_values[5].id;
                   }
                   else if(elementArray[i].custom_values[5].title == "Square Feet"){
                   Square_Feet = elementArray[i].custom_values[5].value;
                   Square_Feetid = elementArray[i].custom_values[5].id;
                   }
                   else if(elementArray[i].custom_values[5].title == "Address"){
                   Address = elementArray[i].custom_values[5].value;
                   Addressid = elementArray[i].custom_values[5].id;
                   }
                   else if(elementArray[i].custom_values[5].title == "Price"){
                   contentPrice = elementArray[i].custom_values[5].value;
                   contentPriceid = elementArray[i].custom_values[5].id;
                   }
                   else if(elementArray[i].custom_values[5].title == "Model"){
                   Model = elementArray[i].custom_values[5].value;
                   Modelid = elementArray[i].custom_values[5].id;
                   }
                   else if(elementArray[i].custom_values[5].title == "Type"){
                   Type = elementArray[i].custom_values[5].value;
                   Typeid = elementArray[i].custom_values[5].id;
                   }
                   else if(elementArray[i].custom_values[5].title == "Color"){
                   Color = elementArray[i].custom_values[5].value;
                   Colorid = elementArray[i].custom_values[5].id;
                   }
                   else if(elementArray[i].custom_values[5].title == "Variant"){
                   Variant = elementArray[i].custom_values[5].value;
                   Variantid = elementArray[i].custom_values[5].id;
                   }
                   else if(elementArray[i].custom_values[5].title == "Year"){
                   Year = elementArray[i].custom_values[5].value;
                   Yearid = elementArray[i].custom_values[5].id;
                   }
                   
                   if(elementArray[i].custom_values[6].title == "House Condition"){
                   House_Condition = elementArray[i].custom_values[6].value;
                   House_Conditionid = elementArray[i].custom_values[6].id;
                   }
                   else if(elementArray[i].custom_values[6].title == "Square Feet"){
                   Square_Feet = elementArray[i].custom_values[6].value;
                   Square_Feetid = elementArray[i].custom_values[6].id;
                   }
                   else if(elementArray[i].custom_values[6].title == "Address"){
                   Address = elementArray[i].custom_values[6].value;
                   Addressid = elementArray[i].custom_values[6].id;
                   }
                   else if(elementArray[i].custom_values[6].title == "Price"){
                   contentPrice = elementArray[i].custom_values[6].value;
                   contentPriceid = elementArray[i].custom_values[6].id;
                   }
                   else if(elementArray[i].custom_values[6].title == "Model"){
                   Model = elementArray[i].custom_values[6].value;
                   Modelid = elementArray[i].custom_values[6].id;
                   }
                   else if(elementArray[i].custom_values[6].title == "Type"){
                   Type = elementArray[i].custom_values[6].value;
                   Typeid = elementArray[i].custom_values[6].id;
                   }
                   else if(elementArray[i].custom_values[6].title == "Color"){
                   Color = elementArray[i].custom_values[6].value;
                   Colorid = elementArray[i].custom_values[6].id;
                   }
                   else if(elementArray[i].custom_values[6].title == "Variant"){
                   Variant = elementArray[i].custom_values[6].value;
                   Variantid = elementArray[i].custom_values[6].id;
                   }
                   else if(elementArray[i].custom_values[6].title == "Year"){
                   Year = elementArray[i].custom_values[6].value;
                   Yearid = elementArray[i].custom_values[6].id;
                   }
                   
                   if(elementArray[i].custom_values[7].title == "House Condition"){
                   House_Condition = elementArray[i].custom_values[7].value;
                   House_Conditionid = elementArray[i].custom_values[7].id;
                   }
                   else if(elementArray[i].custom_values[7].title == "Square Feet"){
                   Square_Feet = elementArray[i].custom_values[7].value;
                   Square_Feetid = elementArray[i].custom_values[7].id;
                   }
                   else if(elementArray[i].custom_values[7].title == "Address"){
                   Address = elementArray[i].custom_values[7].value;
                   Addressid = elementArray[i].custom_values[7].id;
                   }
                   else if(elementArray[i].custom_values[7].title == "Price"){
                   contentPrice = elementArray[i].custom_values[7].value;
                   contentPriceid = elementArray[i].custom_values[7].id;
                   }
                   else if(elementArray[i].custom_values[7].title == "Model"){
                   Model = elementArray[i].custom_values[7].value;
                   Modelid = elementArray[i].custom_values[7].id;
                   }
                   else if(elementArray[i].custom_values[7].title == "Type"){
                   Type = elementArray[i].custom_values[7].value;
                   Typeid = elementArray[i].custom_values[7].id;
                   }
                   else if(elementArray[i].custom_values[7].title == "Color"){
                   Color = elementArray[i].custom_values[7].value;
                   Colorid = elementArray[i].custom_values[7].id;
                   }
                   else if(elementArray[i].custom_values[7].title == "Variant"){
                   Variant = elementArray[i].custom_values[7].value;
                   Variantid = elementArray[i].custom_values[7].id;
                   }
                   else if(elementArray[i].custom_values[7].title == "Year"){
                   Year = elementArray[i].custom_values[7].value;
                   Yearid = elementArray[i].custom_values[7].id;
                   }
                   
                   if(elementArray[i].custom_values[8].title == "House Condition"){
                   House_Condition = elementArray[i].custom_values[8].value;
                   House_Conditionid = elementArray[i].custom_values[8].id;
                   }
                   else if(elementArray[i].custom_values[8].title == "Square Feet"){
                   Square_Feet = elementArray[i].custom_values[8].value;
                   Square_Feetid = elementArray[i].custom_values[8].id;
                   }
                   else if(elementArray[i].custom_values[8].title == "Address"){
                   Address = elementArray[i].custom_values[8].value;
                   Addressid = elementArray[i].custom_values[8].id;
                   }
                   else if(elementArray[i].custom_values[8].title == "Price"){
                   contentPrice = elementArray[i].custom_values[8].value;
                   contentPriceid = elementArray[i].custom_values[8].id;
                   }
                   else if(elementArray[i].custom_values[8].title == "Model"){
                   Model = elementArray[i].custom_values[8].value;
                   Modelid = elementArray[i].custom_values[8].id;
                   }
                   else if(elementArray[i].custom_values[8].title == "Type"){
                   Type = elementArray[i].custom_values[8].value;
                   Typeid = elementArray[i].custom_values[8].id;
                   }
                   else if(elementArray[i].custom_values[8].title == "Color"){
                   Color = elementArray[i].custom_values[8].value;
                   Colorid = elementArray[i].custom_values[8].id;
                   }
                   else if(elementArray[i].custom_values[8].title == "Variant"){
                   Variant = elementArray[i].custom_values[8].value;
                   Variantid = elementArray[i].custom_values[8].id;
                   }
                   else if(elementArray[i].custom_values[8].title == "Year"){
                   Year = elementArray[i].custom_values[8].value;
                   Yearid = elementArray[i].custom_values[8].id;
                   }
                   ...
                   elementId = id;
                   var confirmPopup = $ionicPopup.confirm({
                                                          title: 'Car Dealers Content Delete!',
                                                          template: 'Are you sure you want to delete this Car Dealers Content?'
                                                          });
                   confirmPopup.then(function(res) {
                                     if(res) {
                                     $ionicLoading.show({template: '<i class="icon ion-loading-a"></i>&nbsp;Please wait...'});
...
control.controller('previewContentCtrl',function($scope,$state,$ionicModal,$ionicLoading,$ionicScrollDelegate,$sce,$http,$ionicActionSheet,$ionicPopup){
                   ...
                   $scope.contentModel = Model;
                   $scope.contentType = Type;
                   $scope.contentColor = Color;
                   $scope.contentVariant = Variant;
                   $scope.contentYear = Year;
                   
                   if(Address == '' || Address == undefined){
                   $scope.contentAddress = '';
                   $scope.dispAddress = true;
                   
                   }
                   else{
                   $scope.contentAddress = Address;
                   $scope.dispAddress = false;
...
//                   alert($scope.addagent.fname);
                   ...
                   $scope.contentCreate.elementModel = Model;
                   $scope.contentCreate.elementType = Type;
                   $scope.contentCreate.elementColor = Color;
                   $scope.contentCreate.elementYear = Year;
                   ...
                   $scope.buttonDeleteArray = imagelist;
                   $scope.contentCreate.elementColor = Color;
                   if(Variant=='Petrol' || Variant=='Diesel' || Variant=='Hybrid' || Variant=='Electric'||Variant=='Natural Gas' || Variant=='Gasoline'){
                   $scope.contentCreate.elementVariant = Variant;
                   $scope.vart=false;
                   $state.reload();
                   }
                   else{
                   $scope.contentCreate.elementVariant = "Other";
                   $scope.vart=true;
                   $scope.contentCreate.elementVariant1 = Variant;
                   $state.reload();
                   }
                   
                   if(contentAdditional_field=='' || contentAdditional_field=='Sale'){
                   $scope.contentCreate.elementAdditional_field = 'Sale';
                   $scope.selectedsale=true;
                   $scope.selectedrent=false;
                   $state.reload();
                   ...
                   $scope.selectedsale=false;
                   $scope.selectedrent=true;
                   $state.reload();
                   }
...
control.controller('editBookCtrl',function($scope,$state,$ionicLoading,$ionicPopup,$ionicModal,$ionicScrollDelegate, $ionicActionSheet,$http){
                  ...
                  $("#bookImage").change(function(){
                   ...
                   $ionicPopup.alert({title: 'Car Dealers',content:"Enter Car Dealers Title & Enter Social Share URL"});
                   }
                   }
                   });
